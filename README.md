...
1. $\bf{\color{#DD6565}[SCIE]}$ Seungkyun Hong, <ins>Sunghyun Ahn</ins>, Youngwan Jo, and Sanghyun Park. <b>"Making Anomalies More Anomalous: Video Anomaly Detection Using a Novel Generator and Destroyer"</b> IEEE Access (2024): TBD. $\bf{\color{#DD6565}(IF: 3.9, JCR: Q2)}$ <b><i>[co-first]</i></b> 
